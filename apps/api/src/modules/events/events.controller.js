...
let EventsController = (() => {
    ...
    (() => {
        ...
        _forceEnd_decorators = [(0, common_1.Post)(':id/end'), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN)];
        _findAll_decorators = [(0, common_1.Get)()];
        _findOne_decorators = [(0, common_1.Get)(':id')];
        __esDecorate(_classThis, null, _create_decorators, { kind: "method", name: "create", static: false, private: false, access: { has: obj => "create" in obj, get: obj => obj.create }, metadata: _metadata }, null, _instanceExtraInitializers);
        __esDecorate(_classThis, null, _forceEnd_decorators, { kind: "method", name: "forceEnd", static: false, private: false, access: { has: obj => "forceEnd" in obj, get: obj => obj.forceEnd }, metadata: _metadata }, null, _instanceExtraInitializers);
